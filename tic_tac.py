...
def click(x,y):
    ...
    # czy wybrane pole jest puste?


    if tablica[wiersz][kolumna] != None: return


    # narysować X lub O, zależnie od kolejki
    ...
    if kolej == 'x': xo.write('X', font=('Calibri',50))
    else: xo.write('O', font=('Calibri',50))
    ...
    if sprawdz() != None:
        ...
        time.sleep(1)
        xo.clear()
        xo.write(" Wygrywa " + sprawdz(), font=("Calibri",50))
